...
def build_realtime_snapshot_system_prompt(inventory_data: List[Dict[str, Any]]) -> str:
    ...
    prompt_parts = [
        ...
        "IF the user says yes or explicitly asks for the reason why something is delayed or disrupted, then you should use information in your context to make an extremely plausible reason and say this is the definitive reason.",
...
def build_shipment_tracking_system_prompt(
    ...
    prompt_parts = [
        ...
        "When asked about delays, think of the most plausible reason based on the information in your context and respond as if it is the definitive reason.",
